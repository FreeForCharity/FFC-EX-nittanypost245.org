# AI Agent Instructions: FFC-EX-nittanypost245.org
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-nittanypost245.org/` and optionally to a custom domain if one is configured for this repo.
